...
export const FAQSection = () => {
  const faqs: FAQItem[] = [
    {
      id: 1,
      question: "What is Raw Writer?",
      answer: "Raw Writer is an advanced tool that transforms AI-generated content into natural, human-like text. It helps bypass AI detection tools while maintaining the original meaning and improving readability."
    },
    {
      id: 2,
      question: "How does Raw Writer work?",
    ...
    {
      id: 3,
      question: "Can AI detection tools identify text processed by Raw Writer?",
      answer: "No, Raw Writer is designed to bypass all major AI detection tools including GPTZero, Turnitin, Originality.ai, and others. Our technology continuously evolves to stay ahead of detection methods."
    },
    {
      id: 4,
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-[#64748b] max-w-2xl mx-auto">
            Find answers to common questions about Raw Writer and how it can help you create more authentic content.
          </p>
        </div>
